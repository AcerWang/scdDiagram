...
CREATE TABLE `DAI` (
  `dai_id` INTEGER(11) NOT NULL PRIMARY KEY AUTO_INCREMENT,
  `doi_id` INTEGER(11),
  `name` varchar(20),
  `value` varchar(40)
);
...
CREATE TABLE `DOI` (
  `doi_id` INTEGER(11) NOT NULL PRIMARY KEY AUTO_INCREMENT,
  `ln_id` integer(11),
  `name` VARCHAR(20),
  `desc` VARCHAR(40)
);
...
CREATE TABLE `DataSet` (
  `ds_id` INTEGER(11) NOT NULL PRIMARY KEY AUTO_INCREMENT,
  `ln_id` INTEGER(11),
  `desc` varchar(40),
  `name` varchar(40)
);
...
CREATE TABLE `FCDA` (
  `fcda_id` INTEGER(11) NOT NULL PRIMARY KEY AUTO_INCREMENT,
  `ds_id` INTEGER(11),
  `ldInst` varchar(20),
  `prefix` varchar(20),
  `lnInst` varchar(20),
...
CREATE TABLE `GSEControl` (
  `gse_id` INTEGER(11) NOT NULL PRIMARY KEY AUTO_INCREMENT,
  `ln_id` INTEGER(11),
  `appID` varchar(40),
  `datSet` varchar(20),
  `cnfRev` varchar(10),
...
CREATE TABLE `IED` (
  `ied_id` INTEGER(11) NOT NULL PRIMARY KEY AUTO_INCREMENT,
  `name` varchar(20),
  `type` varchar(20),
...
CREATE TABLE `Inputs` (
  `ext_id` INTEGER(11) NOT NULL PRIMARY KEY AUTO_INCREMENT,
  `ln_id` INTEGER(11),
  `iedName` varchar(20),
  `prefix` varchar(20),
  `doName` varchar(20),
...
CREATE TABLE `LDevice` (
  `ld_id` INTEGER(11) NOT NULL PRIMARY KEY AUTO_INCREMENT,
  `ap_id` INTEGER(11),
  `ld_inst` varchar(20),
  `desc` varchar(40)
);
...
CREATE TABLE `LNode` (
  `ln_id` INTEGER(11) NOT NULL PRIMARY KEY AUTO_INCREMENT,
  `ld_id` INTEGER(11),
  `lnType` varchar(40),
  `lnClass` varchar(20),
  `prefix` varchar(20),
...
CREATE TABLE `LogControl` (
  `lc_id` INTEGER(11) NOT NULL PRIMARY KEY AUTO_INCREMENT,
  `ln_id` INTEGER(11),
  `name` varchar(40),
  `datSet` varchar(40),
  `intgPd` varchar(10),
...
CREATE TABLE `ReportControl` (
  `rc_id` INTEGER(11) NOT NULL PRIMARY KEY AUTO_INCREMENT,
  `ln_id` INTEGER(11),
  `name` varchar(40),
  `datSet` varchar(40),
  `intgPd` varchar(10),
