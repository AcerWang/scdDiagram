select LN.id,IEDTree.IED,ExtRef.iedName,ExtRef.lnClass,ExtRef.lnInst,ExtRef.ldInst from (LN,ExtRef) 
...
select LN.* from LN 
INNER JOIN IEDTree on LN.ldevice_id=IEDTree.LD_id 
where LN.lnClass='TVTR' and IEDTree.IED ='MM1101A' and IEDTree.LDevice ='MUSV01' and LN.inst in (1)
